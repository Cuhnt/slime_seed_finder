...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "wasm_gui.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "wasm_gui.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'wasm_gui'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'wasm_gui':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        ...
        initialize: function( instance ) {
            ...
            Module.exports.slime_seed_finder = function slime_seed_finder(o) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.slime_seed_finder(Module.STDWEB_PRIVATE.prepare_any_arg(o)));
}
;
                Module.exports.river_seed_finder = function river_seed_finder(o) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.river_seed_finder(Module.STDWEB_PRIVATE.prepare_any_arg(o)));
}
;
                Module.exports.draw_rivers = function draw_rivers(o) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.draw_rivers(Module.STDWEB_PRIVATE.prepare_any_arg(o)));
}
;
                Module.exports.generate_rivers_candidate = function generate_rivers_candidate(o) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.generate_rivers_candidate(Module.STDWEB_PRIVATE.prepare_any_arg(o)));
}
;
                Module.exports.count_candidates = function count_candidates(o) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.count_candidates(Module.STDWEB_PRIVATE.prepare_any_arg(o)));
}
;
                Module.exports.draw_reverse_voronoi = function draw_reverse_voronoi(o) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.draw_reverse_voronoi(Module.STDWEB_PRIVATE.prepare_any_arg(o)));
}
;
                Module.exports.extend48 = function extend48(s) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.extend48(Module.STDWEB_PRIVATE.prepare_any_arg(s)));
}
;
                Module.exports.count_rivers = function count_rivers(o) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.count_rivers(Module.STDWEB_PRIVATE.prepare_any_arg(o)));
}
;
                Module.exports.generate_fragment = function generate_fragment(fx, fy, seed, frag_size) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.generate_fragment(fx, fy, Module.STDWEB_PRIVATE.prepare_any_arg(seed), Module.STDWEB_PRIVATE.prepare_any_arg(frag_size)));
}
;
                Module.exports.generate_fragment_up_to_layer = function generate_fragment_up_to_layer(fx, fy, seed, frag_size, layer) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.generate_fragment_up_to_layer(fx, fy, Module.STDWEB_PRIVATE.prepare_any_arg(seed), Module.STDWEB_PRIVATE.prepare_any_arg(frag_size), Module.STDWEB_PRIVATE.prepare_any_arg(layer)));
}
;
                Module.exports.generate_fragment_slime_map = function generate_fragment_slime_map(fx, fy, seeds, frag_size) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.generate_fragment_slime_map(fx, fy, Module.STDWEB_PRIVATE.prepare_any_arg(seeds), Module.STDWEB_PRIVATE.prepare_any_arg(frag_size)));
}
;
                Module.exports.add_2_n = function add_2_n(seed, n) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.add_2_n(Module.STDWEB_PRIVATE.prepare_any_arg(seed), Module.STDWEB_PRIVATE.prepare_any_arg(n)));
}
;
                Module.exports.sub_2_n = function sub_2_n(seed, n) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.sub_2_n(Module.STDWEB_PRIVATE.prepare_any_arg(seed), Module.STDWEB_PRIVATE.prepare_any_arg(n)));
}
;
                Module.exports.gen_test_seed_base_n_bits = function gen_test_seed_base_n_bits(base, n, bits) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.gen_test_seed_base_n_bits(Module.STDWEB_PRIVATE.prepare_any_arg(base), Module.STDWEB_PRIVATE.prepare_any_arg(n), Module.STDWEB_PRIVATE.prepare_any_arg(bits)));
}
;
            __web_on_grow();
